...
urlpatterns = [
    ...
    path("api/volume/<int:volume>", views.set_volume_api, name="set_volume_api"),
    path("api/volume", views.get_volume_api, name="get_volume_api"),
    path("api/pos", views.get_song_pos_api, name="get_song_pos_api"),
    path("api/pos/<int:pos>", views.set_song_pos_api, name="set_song_pos_api"),
